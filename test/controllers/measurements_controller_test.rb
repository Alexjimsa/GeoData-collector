...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference("Measurement.count") do
      post measurements_url, params: { measurement: { dip: @measurement.dip, latitude: @measurement.latitude, longitude: @measurement.longitude, strike: @measurement.strike } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { dip: @measurement.dip, latitude: @measurement.latitude, longitude: @measurement.longitude, strike: @measurement.strike } }
